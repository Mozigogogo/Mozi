...
const i18n = {
  zh: {
    ...
    predictBetPointsBtn: '下注积分',
    predictBetPoints100Btn: '100积分',
    predictBetPoints200Btn: '200积分',
    predictBetPointsCustomBtn: '自定义积分',
    predictBetBackBtn: '« 返回',
    predictBetPointsSelectedToast: (pts) => `已选择 ${pts} 积分，请选择涨或跌`,
    predictBetCustomInputToast: '请输入积分数量（纯数字）',
    predictBetCustomInputInvalid: '请输入大于 0 的整数积分',
...
点击下方 <b>启动</b>，将打开 Mozi Mini App 并进入 <b>账户 / 注册</b> 页面。完成后回到群内即可继续使用 <code>/ai</code>、<code>/chat</code>、<code>/bigorder</code>、<code>/balance</code>。`,
  ...
  en: {
    ...
    predictBetPointsBtn: 'Bet points',
    predictBetPoints100Btn: '100 pts',
    predictBetPoints200Btn: '200 pts',
    predictBetPointsCustomBtn: 'Custom points',
    predictBetBackBtn: '« Back',
    predictBetPointsSelectedToast: (pts) => `Selected ${pts} points — pick Up or Down`,
    predictBetCustomInputToast: 'Send a number for your stake',
    predictBetCustomInputInvalid: 'Enter a positive integer for points',
