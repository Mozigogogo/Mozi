...
const i18n = {
  zh: {
    ...
    predictCustomInputPlaceholder: '▎ 输入币种…',
    predictCustomInputDisplay: (sym) => `▎ ${sym}`,
    predictCustomCancelBtn: '✕',
    predictCustomConfirmBtn: '✓',
    predictCustomInputTapHint: '请在下方输入框输入币种，再点 ✓ 确认',
...
点击下方 <b>启动</b>，将打开 Mozi Mini App 并进入 <b>账户 / 注册</b> 页面。完成后回到群内即可继续使用 <code>/ai</code>、<code>/chat</code>、<code>/bigorder</code>、<code>/balance</code>。`,
  ...
  en: {
    ...
    predictCustomInputPlaceholder: '▎ Enter symbol…',
    predictCustomInputDisplay: (sym) => `▎ ${sym}`,
    predictCustomCancelBtn: '✕',
    predictCustomConfirmBtn: '✓',
    predictCustomInputTapHint: 'Type a symbol below, then tap ✓',
