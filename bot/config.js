...
/** GET 涨跌竞猜详情（相对 API_BASE_URL），默认 coinDirectionGuess/detail */
const COIN_DIRECTION_GUESS_DETAIL_PATH = (
...
/** 涨跌竞猜最高下注积分（含自定义输入） */
const COIN_DIRECTION_GUESS_MAX_BET_AMOUNT = Math.max(
...
/** 定时自动发布时间（北京时间 HH:mm），默认 12:20 */
const PREDICT_AUTO_PUBLISH_TIME = (
  process.env.PREDICT_AUTO_PUBLISH_TIME || '12:20'
).trim();
