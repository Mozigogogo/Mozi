...
export default function CommunityPage() {
  ...
  const recommendActive = isEn ? 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/images/community/recommend_en_active@2x.png' : 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/images/community/recomand_active@2x.png';
  const recommendInactive = isEn ? 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/images/community/recommend_en_no_active@2x.png' : 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/images/community/recomand_no_active@2x.png';
  const hotActive = isEn ? 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/images/community/hot_range_en_active@2x.png' : 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/images/community/hot_range_active@2x.png';
  const hotInactive = isEn ? 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/images/community/hot_range_en_no_active@2x.png' : 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/images/community/hot_range_no_active@2x.png';
  const newsActive = isEn ? 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/images/community/news_en_active@2x.png' : 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/images/community/news_active@2x.png';
  const newsInactive = isEn ? 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/images/community/news_en_no_active@2x.png' : 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/images/community/news_no_active@2x.png';
  ...
  const handleShare = (eOrPost, maybePost) => {
    ...
    const shareUrl = `https://moziai.xyz/commentinfo?id=${post.id}`;
    const shareText = post.title || '来自 MoziInnovations 社区的帖子';
