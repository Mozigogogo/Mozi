      ...
      <div className={styles.statsGrid}>
        <div className={styles.statCard}>
          ...
          <div className={styles.statValueRow}>
            ...
            <img src="https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/icons/gift.svg" alt={t('points.imageAlts.poolGift')} className={styles.statIcon} />
          </div>
        </div>
        <div className={styles.statCard}>
          ...
          <div className={styles.statValueRow}>
            ...
            <img src="https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/icons/balance.svg" alt={t('points.imageAlts.poolBalance')} className={styles.statIcon} />
          </div>
        </div>
      </div>
