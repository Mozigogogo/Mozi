  ...
  return (
    <section className={styles.card}>
      <div className={styles.header}>
        <img src="https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/task_daily.svg" alt={t('points.imageAlts.dailyHeader')} className={styles.headerIcon} />
