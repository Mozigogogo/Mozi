    ...
    monthly: [
      {
        ...
        features: [
          { label: '基础行情', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Basic_market .svg' },
          { label: 'APP基础推送', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Information_push.svg' },
          { label: '邮件告警', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Email_alert.svg' },
          { label: '大单行情', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Order_situation.svg' },
          { label: 'AI Call', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/icons/ai-call.gray.svg' },
          { label: '月度积分', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Monthly_points.svg' },
          { label: '专属标志', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Exclusive_logo.svg' },
          { label: '无广告', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/No_advertisement.svg' },
          { label: '多主题切换', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Topic_witching.svg' },
          { label: '客服', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Customer_service.svg' },
          { label: 'Alpha核心群', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Alpha_core_group.svg' },
        ],
        buttonText: '开始体验',
        isPopular: false,
      ...
      },
      {
        ...
        features: [
          ...
          { label: 'APP基础推送', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Information_push.svg' },
          { label: '邮件告警', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Email_alert.svg' },
          { label: '大单行情 20档深度（5s延迟）', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Order_situation.svg' },
          { label: 'AI Call 20次/月', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/icons/ai-call.gray.svg' },
          { label: '月度积分 5000/月', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Monthly_points.svg' },
          { label: '专属标志', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Exclusive_logo.svg' },
          { label: '无广告', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/No_advertisement.svg' },
          { label: '多主题切换', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Topic_witching.svg' },
          { label: '标准客服', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Customer_service.svg' },
          { label: 'Alpha核心群', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Alpha_core_group.svg' },
        ],
        buttonText: '立即购买',
        isPopular: true,
      ...
      },
      {
        ...
        features: [
          ...
          { label: 'APP基础推送', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Information_push.svg' },
          { label: '邮件告警', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Email_alert.svg' },
          { label: '大单行情 40档深度（0s延迟）', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Order_situation.svg' },
          { label: 'AI Call 40~220次/月', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/icons/ai-call.gray.svg' },
          { label: '月度积分 10000~10,000/月', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Monthly_points.svg' },
          { label: '专属黑金标志', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Exclusive_logo.svg' },
          { label: '无广告', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/No_advertisement.svg' },
          { label: '多主题切换', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Topic_witching.svg' },
          { label: '专属客服', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Customer_service.svg' },
          { label: 'Alpha核心群', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Alpha_core_group.svg' },
        ],
        buttonText: '立即购买',
        isPopular: false,
    ...
    yearly: [
      {
        ...
        features: [
          ...
          { label: '大单行情', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Order_situation.svg' },
          { label: 'AI Call', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/icons/ai-call.gray.svg' },
          { label: '年度积分', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Monthly_points.svg' },
          { label: '专属标志', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Exclusive_logo.svg' },
          { label: '无广告', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/No_advertisement.svg' },
          { label: '多主题切换', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Topic_witching.svg' },
          { label: '客服', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Customer_service.svg' },
      ...
      },
      {
        ...
        features: [
          ...
          { label: '大单行情 20档深度（5s延迟）', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Order_situation.svg' },
          { label: 'AI Call 20次/月', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/icons/ai-call.gray.svg' },
          { label: '年度积分 5000/月', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Monthly_points.svg' },
          { label: '专属标志', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Exclusive_logo.svg' },
          { label: '无广告', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/No_advertisement.svg' },
          { label: '多主题切换', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Topic_witching.svg' },
          { label: '标准客服', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Customer_service.svg' },
      ...
      },
      {
        ...
        features: [
          ...
          { label: '大单行情 40档深度（0s延迟）', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Order_situation.svg' },
          { label: 'AI Call 40~220次/月', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/icons/ai-call.gray.svg' },
          { label: '年度积分 10000~10,000/月', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Monthly_points.svg' },
          { label: '专属黑金标志', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Exclusive_logo.svg' },
          { label: '无广告', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/No_advertisement.svg' },
          { label: '多主题切换', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Topic_witching.svg' },
          { label: '专属客服', icon: 'https://image-1317406749.cos.ap-shanghai.myqcloud.com/mozi_public/point/Customer_service.svg' },
